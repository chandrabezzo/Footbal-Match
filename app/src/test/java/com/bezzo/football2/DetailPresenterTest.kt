...
import com.bezzo.football2.features.detail.DetailContracts
import com.bezzo.football2.features.detail.DetailPresenter
    ...
    fun getAwayBadge(){
        ...
        for (team in teams){
            if (team.idTeam == idAway){
                ...
                assertEquals(team.teamName, homeTeam)
