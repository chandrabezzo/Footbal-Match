package com.bezzo.core.service
...
import com.bezzo.core.util.Gps
...
class UpdateLocationService : Service(), LocationListener {
    ...
    override fun onLocationChanged(location: Location) {
        ...
        if (!Gps.isMockLocationOn(location)) {
            ...
            lastLocation.latitude = sessionHelper.getSession(SessionConstants.LATITUDE,
                    0.toDouble()) ?: 0.toDouble()
            lastLocation.longitude = sessionHelper.getSession(SessionConstants.LONGITUDE,
                    0.toDouble()) ?: 0.toDouble()
